<?php
    ...
    $article = array(
        'title'             =>      'This is the Sample article',
        'short_description' =>      'well its a sample article',
        'article_url'       =>      'sample-article.php',
		'article_img'       =>      'sadiq-boring.jpg', 
...
?>
            ...
            <div class="grid-70 prefix-15 mobile-grid-100 tablet-grid-100">
                ...
                <img src="../images/sadiq-boring.jpg" /><br>
